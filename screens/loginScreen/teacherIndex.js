        ...
        if (response.status == "ok") {
          ...
          global.user = await User._saveToStorage(
            constructUserObject({
              ...
              pdf_announcements:
                response.body.user.pdf_announcements !== undefined
              ...
              notifications: {
                dailyAnnouncements:
                  response.body.user.notifications.daily_announcements || false,
                nextClass: response.body.user.notifications.next_class || false,
                newAssignments:
                  response.body.user.notifications.new_assignments !== undefined
                    ? response.body.user.notifications.new_assignments
                    : true,
                markedAssignments:
                  response.body.user.notifications.marked_assignments || false,
                imageReplies:
                  response.body.user.notifications.image_replies !== undefined
                    ? response.body.user.notifications.image_replies
                    : true,
                upcomingEvents:
                  response.body.user.notifications.upcoming_events !== undefined
                    ? response.body.user.notifications.upcoming_events
                    : true,
                activities: response.body.user.notifications.activities || false
              },
              ...
              automaticMarkRetrieval:
                response.body.user.automatic_mark_retrieval || false,
              automaticCourseUpdating:
                response.body.user.automatic_course_retrieval !== undefined

...
export class User {
  constructor(user) {
    this.account_type = user.account_type || "user";
    ...
    this.automaticCourseUpdating =
      user.automaticCourseUpdating !== undefined
    ...
    this.scheduled_dark_theme = user.scheduled_dark_theme !== undefined
      ? user.scheduled_dark_theme
      : true;
    ...
    this.pdf_announcements =
      user.pdf_announcements !== undefined ? user.pdf_announcements : true;

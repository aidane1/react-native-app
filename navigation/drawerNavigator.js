...
import ArrangeScreen from "../screens/arrangeDrawerScreen/index";
import TeacherLogin from "../screens/loginScreen/teacherIndex";
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <View style={{ width: 50 }}>{this.props.icon}</View>
...
class CustomDrawerContentComponent extends Component {
  ...
  componentDidMount() {
    // setInterval(() => {
    //   this.scrollView.current.flashScrollIndicators ();
    // }, 1000);
  }
  handleScroll = event => {
    Animated.event([
...
const DrawerNavigator = createDrawerNavigator(
  {
    ...
    TeacherLogin: { screen: TeacherLogin, lazy: true },
    ...
    Arrange: { screen: ArrangeScreen, lazy: true }
  },
  {
...
const StackNavigator = createStackNavigator(
  {
    ...
    Polls: { screen: PollScreen, lazy: true },
    Feedback: { screen: FeedbackScreen, lazy: true },
    Arrange: { screen: ArrangeScreen, lay: true }
  },
  {

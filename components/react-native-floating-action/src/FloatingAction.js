...
class FloatingAction extends Component {
  ...
  renderMainButton () {
    ...
    if (['left', 'right'].indexOf (position) > -1) {
      propStyles[position] = distanceToEdge - ifIphoneX (45, 30);
    }
  ...
  render () {
    ...
    return (
      <Animated.View
        ...
        style={[styles.overlay, {backgroundColor: 'transparent'}, {zIndex: 1000}]}
      >

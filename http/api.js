...
class ApexAPI {
  ...
  static authenticate = (username, password, school, account_type = "user") => {
    ...
    if (account_type === "user") {
      ...
      return fetch("https://www.apexschools.co/api/v1/app-teacher", {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
  ...
  static authenticate_school = (username, school) => {
    return fetch("https://www.apexschools.co/api/v1/app-teacher", {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
